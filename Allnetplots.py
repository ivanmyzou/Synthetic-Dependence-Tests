...
addcompare[30] = writepowers(getfeatures('Test/n30add.txt','Test/n30addIMAGE.txt',
                                         30),
                             model,30,threshold)
addcompare[50] = writepowers(getfeatures('Test/Additional Tests/n50add.txt','Test/Additional Tests/n50addIMAGE.txt',
                                         50),
                             model,50,threshold)
addcompare[100] = writepowers(getfeatures('Test/Additional Tests/n100add.txt','Test/Additional Tests/n100addIMAGE.txt',
                                          100),
                              model,100,threshold)
addcompare[200] = writepowers(getfeatures('Test/Additional Tests/n200add.txt','Test/Additional Tests/n200addIMAGE.txt',
                                          200),
                              model,200,threshold)
addcompare[300] = writepowers(getfeatures('Test/Additional Tests/n300add.txt','Test/Additional Tests/n300addIMAGE.txt',
                                          300),
                              model,300,threshold)
...
for n in crosscompare.keys():
    crosscompare[n] = writepowers(getfeatures('Test/Increasing Noises/INCcross'+str(n)+'.txt',
...
for n in circcompare.keys():
    circcompare[n] = writepowers(getfeatures('Test/Increasing Noises/INCcirc'+str(n)+'.txt',
...
for n in sinecompare.keys():
    sinecompare[n] = writepowers(getfeatures('Test/Increasing Noises/INCsine'+str(n)+'.txt',
...
for n in ptscompare.keys():
    ptscompare[n] = writepowers(getfeatures('Test/Increasing Noises/INCpts'+str(n)+'.txt',
